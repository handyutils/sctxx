...
| Note | Source | Verdict |
| --- | --- | --- |
| **[Who has the best proven results, and what to take](2026-09-11-best-proven-oss-algorithm.md)** | survey | **The answer.** No best-proven algorithm exists for a handoff; masking is the only strategy with an ablation, and the 2026 re-test narrows its parity claim. |
| [Production OSS condensers](2026-09-11-candidate-production-oss-condensers.md) | OpenHands, Codex, Cline, SWE-agent, Aider | **Negative findings.** No OpenHands ablation for any condenser; Codex compaction has no evaluation; no production agent attributes a benchmark score to its compaction. |
| [2026 successors to observation masking](2026-09-11-2026-successors-to-observation-masking.md) | AttnCompress (ISSTA 2026), Handoff Debt, SelfCompact | **Narrowed, not superseded.** Handoff Debt is the closest work to sctxx and has no addressable-retrieval arm. |
| [CompactionRL](2026-09-11-candidate-compactionrl.md) | [arXiv:2607.05378](https://arxiv.org/abs/2607.05378) | **Rejected.** Best numbers in the field, no published checkpoint, 8-GPU training harness. |
