...
- **`docs/SCTXX-SPEC.md`** — architecture reference; read the sections the active block cites.
...
Use the terms defined in `docs/SCTXX-SPEC.md` and the glossary in `AGENTS.md`: IR, active branch, ledgers, masked
